  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Data Klub</h1>
          </div>
          <!-- /.col -->
          <div class="col-sm-6">
            ...
            <!-- general form elements -->
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Tambah Data Klub</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="/tampilan-klasemen" method="POST">
                  @csrf 
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input name="nama_klub" type="text" class="form-control @error('nama_klub') is-invalid @enderror" id="nama_club" placeholder="Nama Klub" required autofocus>
                      @error('nama_klub')
                    ...
                    <div class="form-group">
                      <label for="kota_club">Kota Klub</label>
                      <input name="kota_klub" type="text" class="form-control @error('kota_klub') is-invalid @enderror" id="kota_club" placeholder="Kota Klub" required>
                      @error('kota_klub')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
...
@section('myJs')
    <script>
        $('a#menu_inputdataclub').addClass('active');
