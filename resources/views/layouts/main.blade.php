...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('template/adminlte/plugins/fontawesome-free/css/all.min.css') }}"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset('template/adminlte/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}"
        />
        <!-- JQVMap -->
        ...
        <link
            rel="stylesheet"
            href="{{ asset('template/adminlte/plugins/daterangepicker/daterangepicker.css') }}"
        />
        <!-- summernote -->
        <link
            rel="stylesheet"
            href="{{ asset('template/adminlte/plugins/summernote/summernote-bs4.min.css') }}"
        />
